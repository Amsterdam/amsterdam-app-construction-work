...
class TestApiProjectWarning(TestCase):
    ...
    def test_get_warning_message_no_identifier(self):
        ...
        self.assertDictEqual(
            result.data,
            {"status": False, "result": "Invalid query parameter(s). See /api/v1/apidocs for more information"},
        )
    ...
    def test_post_warning_message_image_upload(self):
        ...
        path = "{cwd}/construction_work/UNITTESTS/image_data/portrait.jpg".format(cwd=os.getcwd())
