...
from construction_work.models import (Article, Assets, FirebaseTokens, Image, ProjectDetails, ProjectManager, Projects,
                                      WarningMessages)
from construction_work.serializers import (ArticleSerializer, AssetsSerializer, ImageSerializer, Notification,
                                           ProjectDetailsSerializer, ProjectManagerSerializer, ProjectsSerializer,
                                           WarningMessagesExternalSerializer, WarningMessagesInternalSerializer)
from construction_work.UNITTESTS.mock_data import TestData
...
class TestWarningMessagesModel(TestCase):
    ...
    def test_default_email(self):
        ...
        data["project_identifier"] = Projects.objects.filter(pk=data["project_identifier"]).first()
