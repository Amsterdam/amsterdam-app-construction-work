...
from construction_work.PushNotifications.SendNotification import SendNotification
...
class TestSendNotification(TestCase):
    ...
    def test_send_warning(self, _firebase_admin_messaging_send_multicast):
        ...
        mock_logging = logging.getLogger("construction_work.GenericFunctions.Logger")
