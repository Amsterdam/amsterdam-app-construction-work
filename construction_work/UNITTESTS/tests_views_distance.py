...
from construction_work.UNITTESTS.mock_functions import address_to_coordinates
from construction_work.UNITTESTS.mock_data import TestData
from construction_work.models import Projects
from construction_work.models import ProjectDetails
