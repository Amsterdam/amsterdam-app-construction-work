...
def remove_orphaned_news(apps, schema_editor):
    ...
    Projects = apps.get_model("construction_work", "Projects")
    News = apps.get_model("construction_work", "News")
...
def remove_orphaned_followed_projects(apps, schema_editor):
    ...
    Projects = apps.get_model("construction_work", "Projects")
    FollowedProjects = apps.get_model("construction_work", "FollowedProjects")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("construction_work", "0002_alter_news_id"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="projectid",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="construction_work.projects"),
        ),
        migrations.AlterField(
            model_name="news",
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(
                default="", on_delete=django.db.models.deletion.CASCADE, to="construction_work.projects"
            ),
        ),
        migrations.AlterField(
