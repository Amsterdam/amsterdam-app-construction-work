...
class TestImageConversion(TestCase):
    ...
    def test_jpg_gps_portrait(self):
        ...
        self.assertDictEqual(
            image_conversion.gps_info,
            {"lon": 6.182558333333334, "lat": 52.14435833333333},
        )
        ...
        self.assertEqual(
            image_conversion.images["original"]["filename"], "original-portrait.jpg"
        )
        ...
        self.assertEqual(
            image_conversion.images["135x180"]["filename"], "135x180-portrait.jpg"
        )
        ...
        self.assertEqual(
            image_conversion.images["324x432"]["filename"], "324x432-portrait.jpg"
        )
        ...
        self.assertEqual(
            image_conversion.images["540x720"]["filename"], "540x720-portrait.jpg"
        )
        ...
        self.assertEqual(
            image_conversion.images["810x1080"]["filename"], "810x1080-portrait.jpg"
        )
