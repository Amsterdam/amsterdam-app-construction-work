...
from construction_work.GenericFunctions.ImageConversion import ImageConversion
...
def warning_messages_image_upload(request):
    ...
    for key in image_conversion.images:  # pylint: disable=consider-using-dict-items
        ...
        image_object = Image(
            ...
            url="db://construction_work.warning_message/{identifier}".format(identifier=identifier),
