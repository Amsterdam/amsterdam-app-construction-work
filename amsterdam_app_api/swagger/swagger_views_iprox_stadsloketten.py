...
as_city_contact = {
    ...
    'responses': {
        200: openapi.Response('application/json',
                              openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_OBJECT,
                                                                                           properties={
...
opening_hours_regular = openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_OBJECT,
                                                                                     properties={
...
opening_hours_exceptions = openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Schema(type=openapi.TYPE_OBJECT,
                                                                                        properties={
    'city_office_id': openapi.Schema(type=openapi.TYPE_STRING, description='city office id (foreign key)'),
